...
$consulta_mysqli="select * from PersonalRH where Emp = '$usuario'";
...
echo "</b>";
echo "<br>";
echo "-Que la clave tiene al menos 6 caracteres";
echo "<br>";
echo "-Que el password tiene como máximo 10 caracteres";
echo "<br>";
echo "-Que tiene al menos 1 letra minúscula";
echo "<br>";
echo "-Que al menos tiene 1 letra mayúscula";
echo "<br>";
echo "-Que tiene al menos un carácter numérico";
echo "<br>";
echo "<br>";
...
echo "<input type='submit' name='Submit' onClick='return compara()'  value='ACTUALIZAR CONTRASEÑA' style='BORDER: #a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</center>";
echo "</form>";
echo "</td>";
echo "</tr>";
