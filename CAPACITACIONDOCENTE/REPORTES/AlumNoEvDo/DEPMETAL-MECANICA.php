...
$html.='<h1>DEPARTAMENTO DE METAL-MECÁNICA</h1>

<h1>DEPARTAMENTO DE METAL-MECÁNICA</h1>

<br>
AÑO: '.date("Y").'
';

$result = $mysqli -> query ("SELECT idPersonal,apePersonal,nomPersonal FROM personal WHERE idDepartamento='6' order by apePersonal");	
