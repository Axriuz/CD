...
<h1>DEPARTAMENTO DE SISTEMAS COMPUTACIONALES</h1>

<br>
AÑO: '.date("Y").'
';

$result = $mysqli -> query ("SELECT idPersonal,apePersonal,nomPersonal FROM personal WHERE idDepartamento='7' order by apePersonal");	
...
$pdf->stream('SISTEMAS COMPUTACIONALES.pdf');
