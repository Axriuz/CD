...
$html.='<h2>DEPARTAMENTO DE CIENCIAS DE LA TIERRA</h2>

<h2>DEPARTAMENTO DE CIENCIAS DE LA TIERRA</h2>

<br>
AÑO: '.date("Y").'
';

$result = $mysqli -> query ("SELECT idPersonal,apePersonal,nomPersonal FROM personal WHERE idDepartamento='2' order by apePersonal");	
