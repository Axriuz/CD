...
$html.='<h1>DEPARTAMENTO DE INGENIERÍA ELÉCTRICA Y ELECTRÓNICA</h1>

<h1>DEPARTAMENTO DE INGENIERÍA ELÉCTRICA Y ELECTRÓNICA</h1>

<br>
AÑO: '.date("Y").'
';

$result = $mysqli -> query ("SELECT idPersonal,apePersonal,nomPersonal FROM personal WHERE idDepartamento='4' order by apePersonal");	
...
$pdf->stream('ELECTRICA Y ELECTRONICA.pdf');
