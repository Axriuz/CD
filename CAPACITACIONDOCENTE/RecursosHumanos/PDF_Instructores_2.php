...
$sqlJefe = "select * from PersonalRH where JefeDpto = '1'";
...
$sqlSub = "select * from PersonalRH where JefeDpto = '2'";
...
$sqli = "select * from EncEvaInsRH where Instructor like '%$a%'";
$resEncuesta=mysqli_query($con,$sqli);


//instructor auxiiar
$sqliq = "select * from EncEvaInsRH where Instructor like '%$a%'";
$resEncuestaq=mysqli_query($con,$sqliq);
while($datoq=mysqli_fetch_array($resEncuestaq)){
    $ay = $datoq[0];
}

$sqliw = "select * from PersonalRH where Nombre like '%$ay%' and ApellidoP like '%$ay%' and ApellidoM like '%$ay%'";
