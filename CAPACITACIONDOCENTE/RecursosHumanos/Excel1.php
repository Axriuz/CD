...
//Consultas SQL
//Obtiene nombre de los maestros que cumplen los criterios para recibir las constancias
...
$Instructor="SELECT maestro.ApellidoP,maestro.ApellidoM,maestro.nombre FROM maestro INNER JOIN curso ON maestro.Emp = curso.instructor WHERE ( curso.instructor=maestro.Emp and curso.nombre='$curso' )";
...
$objPHPExcel->getActiveSheet()->SetCellValue('G6',"DOCENTES QUE RECIBEN CONSTANCIA");
