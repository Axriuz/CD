...
$sql="SELECT maestro.ApellidoP,maestro.ApellidoM,maestro.nombre FROM maestro INNER JOIN matriculas ON maestro.Emp = matriculas.Emp INNER JOIN curso ON curso.nombre = matriculas.curso WHERE ( matriculas.curso =  '$curso' AND Constacia =  'Entregada'  ) order by maestro.ApellidoP,maestro.ApellidoM,maestro.Nombre"; 
...
$html.= '<br>';
$html.= 'LISTA DE DOCENTES CON CONSTANCIAS ENTREGADAS';
...
//$mipdf ->Image('sep.jpg',10,72,150);
 ...
 $pdf->Output();
    ...
    window.location.href="periodolistas4.php";
    </script>';
 }
 ?>
