...
$html.= '</tr>';
$html.= '</TABLE>';*/
$sql="SELECT Nombre,Objetivo,CursoInicio,CursoFin,Tec,Instructor,InsAux from cursoRH where Year(CursoInicio)='$a' and Periodo='$p' order by Nombre";
...
$html.=  mb_strtoupper($dato[1], "UTF-8");
	...
	$html.= '</td>';
		...
		$cadena="";
$sql1="SELECT ApellidoP,ApellidoM,Nombre,Area from PersonalRH where Emp=$dato[5]"; 
