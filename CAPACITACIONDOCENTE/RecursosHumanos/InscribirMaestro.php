...
echo "<td>";
echo "<center>";
echo "ALTA DE PERSONAL";
echo "<br>";
echo "<br>";
echo "<br>";
echo "Ingrese el número de SIE del personal a registrar:";
echo "<br>";
echo "<input type=text  name='Nombre'  onkeypress='return valida(event)' maxlength='4' size ='10' required>";
echo "<br>";
echo "<br>";
echo "Ingrese el nombre del personal (MAYUSCULAS):";
echo "<br>";
...
echo 'Sexo
	...
	<select name='Area'>
		...
		<option value='Subdirección de planeación'>Subdirección de planeación</option>
