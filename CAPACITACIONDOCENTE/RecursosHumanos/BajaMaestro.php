...
$sql1="SELECT Emp,Nombre,ApellidoP,ApellidoM from `PersonalRH` WHERE Emp = $Emp";
...
echo "<br>";
	   ...
	   echo '<input type="text" name="ap" value="'.$row[2].'" hidden="true">'; 
	   echo '<input type="text" name="am" value="'.$row[3].'" hidden="true">'; 
