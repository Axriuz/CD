...
$consulta_mysqli='select Emp from matriculasRH where Curso="'.$cursos.'"';
...
while($fila=mysqli_fetch_array($resultado_consulta_mysqli)){
	...
	$consulta_mysqli1='select Emp,ApellidoP,ApellidoM,Nombre from PersonalRH where Emp="'.$fila['Emp'].'" order by ApellidoP,ApellidoM';
