...
$html.= '<center>';	
$html.= "<h3>";
$html.= utf8_decode('CURSOS DEPARTAMENTO DE '.mb_strtoupper($curso, "UTF-8"));
$html.= "</h3>";
$html.= '<br>';
$html.=utf8_decode( mb_strtoupper('AÑO: '.$anio." PERIODO: ".mb_strtoupper((utf8_decode(utf8_encode($p))),'UTF-8'), "UTF-8"));
$html.= '</center>';	
$html.= "<br>";
	$contador=1;
	$CURSOS= array();
...
$mipdf ->render();
$mipdf ->stream('CURSOS POR FECHAS DE '.mb_strtoupper((utf8_decode(utf8_encode($curso))),'UTF-8').' PERIODO: '.mb_strtoupper((utf8_decode(utf8_encode($p))),'UTF-8').' AÑO: '.$anio.'.pdf');
