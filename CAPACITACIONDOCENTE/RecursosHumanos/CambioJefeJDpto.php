...
echo"<IMG SRC='../Img/docentes.png' width='115' height='115' >";
echo "</td>";
echo "<td>";

echo "<center>";
echo "<strong>";
echo "JEFE DE DEPARTAMENTO POR AREA";
echo "</strong>";
echo"<br>";
echo"<br>";
echo "<strong>";
echo "Jefes de Departamento Actual:";
echo "</strong>";
echo"<br>";
$consulta_mysqli='select * from maestro where JefeDpto = 1';
$resultado_consulta_mysqli=mysqli_query($con,$consulta_mysqli);
  
echo "<select name='anteriorA'>";
...
echo"<br>";
echo "<strong>";
echo "Seleccione el Nuevo Jefe de Departamento:";
echo "</strong>";
echo"<br>";
$consulta_mysqli="select * from maestro where JefeDpto != 1 and  JefeDpto != 3 and  JefeDpto != 2  AND nombre !=  'DESARROLLO_ACADEMICO' and Nombre != ' '   ";
$resultado_consulta_mysqli=mysqli_query($con,$consulta_mysqli);
