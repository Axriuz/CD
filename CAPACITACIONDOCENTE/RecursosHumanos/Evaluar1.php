...
$sqlNomIns="select * from PersonalRH where Emp = '$Ins'";
...
$sql = "INSERT INTO `EncEvaInsRH`(`Instructor`, `EmpIns`, `Fecha`, `Fp`,`Ec`, `Md`,`Ch`, `Ed`, `Ca`) VALUES  ('$auxiliar', '$EmpIns', '$Fecha', '$Fp','$Ec','$Md','$Ch', '$Ed', '$Ca')";
	$result = mysqli_query($con,$sql, $conexion );

IF ($RES > 24)
{$sql1 = "UPDATE cursoRH set Ins_evaluado = 1 where Instructor = $Ins";
