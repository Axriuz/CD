...
echo "<td>";
echo "<center>";
echo "BAJA DE PERSONAL";
echo "<br>";
echo "<br>";

echo "Ingrese los 4 digitos corresondientes al número de SIE del personal a eliminar:";
echo "<br>";
echo '<input type=password name="numero1" onkeypress="return valida(event)" maxlength="4" >';
echo "<br>";
echo "<br>";
echo "Confirmar número de SIE del personal a eliminar:";
echo "<br>";
