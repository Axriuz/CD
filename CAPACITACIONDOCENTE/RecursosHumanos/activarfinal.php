...
$query="update cursoRH set validado=1 where Nombre='$curso'";//consulta sql
...
echo '<center><h1>CURSO '.utf8_decode($curso).' ACTIVADO Y VALIDADO<br><br>';
echo "<a href='seleccionar_anio_curso.php'>Regresar</a></center></h1><br><br>";
}
