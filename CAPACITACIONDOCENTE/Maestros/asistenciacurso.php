...
<head>
    ...
    <title>Asistencia del curso</title>
    ...
    <!--Header -->
        ...
        <?php
            ...
            if ($resultado) { 
                ...
                {
                    echo '<center><h2>No es instructor de ningún curso</h2></center>';
                }
                else
                {echo "<table width='100%' border='7' cellpadding=30 CELLSPACING=30  bordercolor='#245c4f' ;>";
                    ...
                    echo "CURSOS INSTRUIDOS";

                    echo "</h2>";

                    echo "<form method='post' action='asignaasistencia.php' >";
                    $consulta_mysqli="select * from curso where  Instructor = '$usuario'";
                    ...
                    echo "<br>";
                    echo "<br>";
                    echo "<input type='submit' name='Submit' value='Asignar asistencia' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
                    echo "<br> <br>";
                    echo "</form>";
                    echo "</CENTER>";
                    echo "</td>";
