...
//Vereificaciﾃｳn de conexiﾃｳn a BD.
...
while ($total = mysqli_fetch_row($result))
  {	
    $cadena= $cadena." ".mb_strtoupper((utf8_decode($total[0])),'UTF-8')."<br>";
   
  }

  while ($total1 = mysqli_fetch_row($result1))
  {	
    $cadena1= $cadena1." ".mb_strtoupper((utf8_decode($total1[0])),'UTF-8')."<br>";
   
  }

  while ($total2 = mysqli_fetch_row($result2))
  {	
    $cadena2= $cadena2." ".mb_strtoupper((utf8_decode($total2[0])),'UTF-8')."<br>";
