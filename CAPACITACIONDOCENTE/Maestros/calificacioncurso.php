        ...
        <?php
            ...
            if ($resultado) { 
                ...
                else
                {
                    ...
                    echo "<form method='post' action='asignacalificacion.php' >";
                    $consulta_mysqli="select * from curso where  Instructor = '$usuario'";
                    ...
                    echo "<br>";
                    echo "<br>";
                    echo "<input type='submit' name='Submit' value='Asignar calificaciones' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
                    echo "<br> <br>";
                    echo "</form>";
                    echo "</CENTER>";
                    echo "</td>";
