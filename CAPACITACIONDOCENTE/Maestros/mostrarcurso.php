...
$consulta_mysqli='select * from curso where (SELECT  area  FROM  maestro, curso   WHERE maestro.Emp = curso.Instructor) = (select area from maestro where emp = '.$usuario.' ) and validado = 0';
