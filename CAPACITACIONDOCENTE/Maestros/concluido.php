         ...
         <div class = "logoleft">
            <div class=logo>
               <!-- <img src=http://www.itcg.edu.mx/imagenes/sep.png title=DGEST height=80px width=250px> -->
                <img src=Resources/sep.png height=80px width=250px>
            </div>
          </div>
<!--
...
-->
            <div class=logoTexto>
                ...
                <img src=Resources/header.png height=80px width=350px>
            </div>

            <div class = "logoright">

              <div class=logo><img src=Resources/itcg_logo.png title=ITCG height=64px width=58px></div>
            </div>
        <!-- </div>  -->
...
<center><h1>CURSO REGISTRADO CON &Eacute;XITO, ESPERE A QUE DESARRLLO ACAD&Eacute;MICO LO ACTIVE<br><br>
<a href='Menu.php'>Regresar</a></center></h1><br><br>
...
<img src="Resources/foot.png" title=ITCG height=99px width=314px>
