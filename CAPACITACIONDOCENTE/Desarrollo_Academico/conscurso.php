...
<br>
	  <!--Fin Menu desarrollo docente-->
        <?php
            $consulta_mysqli="select * from curso where Instructor = '$usuario'";
            ...
            if ($resultado) { 
                    ...
                    echo "<br>";
                    echo "<h2>";
                    echo "CURSO A GENERAR CONSTANCIA";
                    echo "</h2>";
					echo "<h4>";
                    echo "SE DESCARGARÁ UN ARCHIVO EXCEL CON LOS DOCENTES CON CALIFICACIÓN MAYOR O IGUAL  A 70";
                    echo "</h4>";

                    echo "<form method='post' action='exportexcel.php' >";
                    $consulta_mysqli="select * from curso";
                    ...
                    echo "<br>";
                    echo "<br>";
                    echo "<input type='submit' name='Submit' value=' Generar Excel ' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
                    echo "<br> <br>";
                    echo "</form>";
                    echo "</CENTER>";
                    echo "</td>";
