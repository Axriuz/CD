...
<head>
 <link type="text/css" rel="stylesheet" href="estiloFormulario.css" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<title>Programando en php</title>
</head>
...
$aluctr=$_REQUEST['aluctr'];
$query="select * from dalumn where aluctr='$aluctr'";
$cierto=mysql_query($query,$con);//ejecutando consulta


if(!$cierto){
echo "No existe!";
echo "<form action='http://201.167.122.93/ed/sesion_jefe.php' method='get'><!---->
...
NÚMERO DE CONTROL
<input type='text' name='aluctr' readonly='readonly' value='$row[aluctr]'>APELLIDO PATERNO
<input type='text' name='alunom' readonly='readonly' value='$row[alunom]'>APELLIDO MATERNO
<input type='text' name='aluapp' readonly='readonly' value='$row[aluapp]'>APELLIDO NOMBRE
<input type='text' name='aluapm' readonly='readonly' value='$row[aluapm]'>PASSWORD
<input type='text' name='alupas' value='$row[alupas]'>

<center>
 <button id='btn-login' type='submit' name='Modificar' value='Modificar'>Modificar</button>
   </center>
</form>";
