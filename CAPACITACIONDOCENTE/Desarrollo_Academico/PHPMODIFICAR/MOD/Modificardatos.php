...
NÚMERO DE CONTROL
<input type='text' name='aluctr' readonly='readonly' value='$row[aluctr]'>NOMBRE
<input type='text' name='alunom' readonly='readonly' value='$row[alunom]'>APELLIDO PATERNO
<input type='text' name='aluapp' readonly='readonly' value='$row[aluapp]'>APELLIDO MATERNO
