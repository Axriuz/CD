...
echo "<input type='submit' name='Submit' onClick='return compara()'  value='ACTUALIZAR CONTRASEÑA' style='BORDER: rgb(210,122,234) 2px solid; BACKGROUND-COLOR: #D149F6; COLOR: #FCFCFD;'>"; 
echo "</center>";
echo "</form>";
echo "</td>";
echo "</tr>";
