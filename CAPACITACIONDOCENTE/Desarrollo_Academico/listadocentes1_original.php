...
echo "<input type ='submit' value= 'Generar Todas las listas' formaction='todosdocentespdf1.php' style='BORDER::rgb(0,43,200) 2px solid; BACKGROUND-COLOR: #0037FF; COLOR: #FCFCFD;'>"; 
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
