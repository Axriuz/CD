...
echo "<form action='get1.php' method='post'>";
...
echo "<center>";
echo "<h2>";
echo "SELECCIONE EL CURSO PARA DESCARGAR CURRICULUM ADICIONAL";
echo "</h2>";
...
echo "<br>";
echo "<br>";
echo "<input type ='submit' value= 'Descargar' style='BORDER: rgb(0,43,200) 2px solid; BACKGROUND-COLOR: #0037FF; COLOR: #FCFCFD;' />";
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
