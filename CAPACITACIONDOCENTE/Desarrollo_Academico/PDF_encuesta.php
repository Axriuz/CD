...
$sqli = "select maestro.Nombre, maestro.ApellidoP,maestro.ApellidoM from maestro INNER JOIN curso on maestro.Emp = curso.Instructor where curso.Nombre = '$cursoq' ";
