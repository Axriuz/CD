...
echo "<form action='S1.php' method='post'>";
...
echo "<input type ='submit' value= 'Generar Lista Excel' formaction='Excel3.php' style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
...
echo "<input type ='submit' value= 'Generar Todas las listas' formaction='S1todos.php' style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
