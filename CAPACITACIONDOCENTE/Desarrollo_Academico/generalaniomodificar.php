...
echo "<form action='reportegralcursosmodificadoanio.php' method='post'>";
...
echo "
<br>Nombre del documento
 <input title='Se requiere información' type='text' name='nombredcto' required>";
echo "  Referencia a normas
<input title='Se requiere información' type='text' name='normas' required>";
echo " <br><br> Código
<input title='Se requiere información' type='text' name='cod' required>";
echo "  Revisión
<input title='Se requiere información' type='text' name='rev' required>
<center><br><br>"; 
