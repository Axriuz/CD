...
where matriculas.Curso = 'CONSTRUCCIONES FISICAS Y SUS MODELOS MATEMATICOS'  and matriculas.Emp = maestro.emp 
...
{	
	...
	$html.= utf8_decode("Fecha: ".$dato12[0]);
...
//$mipdf ->Image('sep.jpg',10,72,150);
 ...
 /*}
    ...
    window.location.href="periodolistas5.php";
    </script>';
 }*/
 ?>