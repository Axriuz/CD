...
echo "<center>";
echo "<h2>";
echo "SELECCIONE EL 脕REA PARA GENERAR REPORTE";
echo "</h2>";
...
echo "<input type ='submit' formaction='ReporteGralAnio.php' value= 'Generar Reporte por a艾涅o'  style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
