...
WHERE ( matriculas.curso =  '$curso' AND Constacia =  'Pendiente (Sin Elaborar)' )
...
$objPHPExcel->getActiveSheet()->SetCellValue('G6',"LISTA DE DOCENTES CON CONSTANCIAS PENDIENTES (SIN ELABORAR)");
...
if($nombre != null){
    ...
    window.location.href="periodolistas2.php";
    </script>';
 }
  ?>