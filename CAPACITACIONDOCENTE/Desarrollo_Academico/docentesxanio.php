...
echo "<form action='cursosinsano.php' method='post'>";
...
echo "<center>";
echo "<h2>";
echo "LISTA DE INSTRUCTORES POR AÑO";
echo "</h2>";
echo "<br>";
...
echo "<input type ='submit' value= 'Todos los cursos'  formaction='todosinsano.php' style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
