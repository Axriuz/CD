...
$html.= '<center>';	
$html.= "<h3>";
$html.= utf8_decode('CURSOS FORMACIÓN DOCENTE');
$html.= "</h3>";
$html.= '<br>';
...
//Consulta que retorna los nombres delos cursos que se tomaron en el periodo seleccionado.
 	$sql11="SELECT Nombre from curso where (Nombre='$dato1[0]' and Periodo='$p' and year(CursoInicio)='$a') and TipoCurso='Formacion Docente'"; 
...
{	
	$cadena= $cadena." ".mb_strtoupper($dato11[0])."<br>";
...
$mipdf ->render();
$mipdf ->stream('CURSOS FORMACIÓN DOCENTE  AÑO'.$a.' PERIODO '.$p.'.pdf');
