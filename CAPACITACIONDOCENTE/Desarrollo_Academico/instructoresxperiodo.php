...
echo "<form action='cursosins.php' method='post'>";
...
$resultado_consulta_mysql1=mysqli_query($conexion,$consulta_mysql1);
$MAX=0;
$MINN=0;
...
echo "<br>";
echo "<br>";
echo "<input type ='submit' value= 'Seleccionar Curso'  style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "<input type ='submit' value= 'Todos los cursos' formaction='todosins.php' style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>";
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
...
<br>
<br>
	<a href="selectinstruc.php"><IMG SRC="../Img/menu.png" WIDTH=150 HEIGHT=45>	 </a>
	</body>
</html>