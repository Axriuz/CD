...
echo "<br>";
echo "<br>";
       echo "<h3>NOMBRE: ".$row[1]." ".$row[2]." ".$row[3]."<h3> </CENTER>";
...
echo "<br>";
 ...
 echo '<input type="text" name="n" value="'.$row[1].'" hidden="true">'; 
	...
	echo "<br><br>";
echo "<input type='submit' name='Submit'   value='CONFIRMAR' >&nbsp;"; 
echo "<input type='button' value='CANCELAR' onclick='history.back(-1)'/>";
...
echo "<input type='button' value='REGRESAR' onclick='history.back(-1)' />";
	echo "<center>";
  }
