...
<nav class="navbar navbar-expand-lg navbar-light bg-#1b396a" style="background-color: #1b396a;" width: 100%>
    ...
    <?php 
        ...
        echo "<CENTER>";
        echo "<h2>";
        echo "PERIODOS DE LOS CURSOS";
        echo "</h2>";
        
        echo "<form method='post' action='pdfcursoperiodo.php' >";
        $consulta_mysqli='select distinct periodo from curso';
        ...
        echo "<br>";echo "<br>";
        $consulta_mysqli='SELECT distinct year(CursoInicio) FROM `curso` where CursoInicio!=0';
        $resultado_consulta_mysqli=mysqli_query($con,$consulta_mysqli); 
        echo "<select name='year'>";
        while($fila=mysqli_fetch_array($resultado_consulta_mysqli)){
            
            echo "<option value='".$fila['year(CursoInicio)']."'>".$fila['year(CursoInicio)']."</option>";
        }
        echo "</select>";  
        echo "<br>";
        echo "<br>";
        echo "<input type='submit' name='Submit'   value='Generar PDF' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
        echo "<br> <br>";
        echo "</form>";
        echo "</CENTER>";
        echo "</td>";
