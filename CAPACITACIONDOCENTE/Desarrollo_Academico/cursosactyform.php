...
echo "<br>";
echo "<br>";
echo "<input type ='submit' value= 'Actualización Profesional' formaction='ActualizacionP.php'>"; 
echo "&nbsp;<input type ='submit' value= 'Formación Docente' formaction='FormDoc.php'>"; 
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
