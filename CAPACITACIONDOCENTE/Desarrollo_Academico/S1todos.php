...
$sql="SELECT maestro.ApellidoP,maestro.ApellidoM,maestro.nombre FROM maestro INNER JOIN matriculas ON maestro.Emp = matriculas.Emp INNER JOIN curso ON curso.nombre = matriculas.curso WHERE ( matriculas.curso =  '$curso' AND Constacia =  'Elaborada'   ) order by maestro.ApellidoP,maestro.ApellidoM,maestro.Nombre"; 
...
$html.= '<br>';
$html.= 'LISTA DE DOCENTES CON CONSTANCIAS ELABORADAS';
