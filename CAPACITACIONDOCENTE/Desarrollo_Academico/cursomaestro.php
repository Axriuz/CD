...
<nav class="navbar navbar-expand-lg navbar-light bg-#1b396a" style="background-color: #1b396a;">
      ...
      <?php
        ...
        echo "<form action=pdfcursomaestro.php method='post'   name= 'f1' id = 'f1'>";
        echo "<tr>";
        echo "<td>";
        ...
        echo "<td>";
        echo "<center>";
        echo "<h2>CONSULTAR CURSOS DEL MAESTRO</h2>";
        ...
        echo "<input type='submit' name='Submit' onClick='return compara()'  value='Buscar los cursos' style='BORDER: #a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
        echo "</center>";
        echo "</form>";
        echo "</td>";
        echo "</tr>";
