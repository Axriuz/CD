...
<td><span style="COLOR: #000000; align="center">		
 ...
 <div id="menu">        
		<ul class="bandera1">    
				...
				<li>MAESTROS
					<ul>
						<li><a href="NOMAESTROS.php" style="color:#ffffff;">NÚMERO DE DOCENTES</a></li> 
						<li><a href="InscribirMaestro.php" style="color:#ffffff;">REGISTRAR MAESTROS</a></li> 
						<li><a href="BorrarMaestro.php" style="color:#ffffff;">ELIMINAR MAESTRO</a></li> 
					...
					<ul>
						...
						<li><a href="AddCursoExt.php" style="color:#ffffff;">PROPONER CURSO EXTERNO</a></li> 
						<li><a href="DeleteCursoExt.php" style="color:#ffffff;">ELIMINAR CURSO EXTERNO</a></li> 
					</ul></li>
				...
				<li>CURSO
					<ul class="bandera2">
						...
						<li><a href="seleccionar_anio_curso.php" style="color:#ffffff;">ACTIVAR CURSO</a></li> 
						...
						<li><a href="GETCV.php" style="color:#ffffff;">DESCARGAR INFORMACIÓN DE CURSO</a></li>  
					</ul></li>
