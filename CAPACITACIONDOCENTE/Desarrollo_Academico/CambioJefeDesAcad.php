...
echo "<form action='CambioJefeDA.php' method='post'>";
...
echo"<IMG SRC='../Img/desarrollo_academico.png' width='115' height='115' >";
echo "</td>";
echo "<td>";

echo "<center>";
echo "<strong>";
echo "JEFE DE DEPARTAMENTO DE DESARROLLO ACADEMICO";
echo "</strong>";
echo"<br>";
echo"<br>";
echo "<strong>";
...
echo"<br>";
echo "<strong>";
echo "Seleccione el Nuevo Jefe de Departamento de Desarrollo Academico:";
echo "</strong>";
echo"<br>";
