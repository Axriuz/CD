...
$consulta_mysqli="select maestro.Emp from maestro inner join matriculas on maestro.Emp=matriculas.Emp inner join curso on matriculas.Curso=curso.nombre where (matriculas.Curso='$curso')";
