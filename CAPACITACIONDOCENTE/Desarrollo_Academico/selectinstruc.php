...
echo "<br>";
echo "<input type ='submit' formaction='instructoresxperiodo.php' value= 'Generar Lista por periodo'>"; 

echo "
<input type='submit' formaction='docentesxanio.php' value= 'Generar Lista por año'>"; 
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
