...
echo"<div style='text-align:center;'>
		...
		<select name='diplo'>
			...
			<option value='DiplomadoEducacionInclusiva'>Diplomado de educación inclusiva</option>
...
echo "<input type='submit' name='Submit' onClick='return compara()'  value='PROCEDER A LA INSCIPCIÓN' style='BORDER: #a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</center>";
echo "</form>";
echo "</td>";
echo "</tr>";
