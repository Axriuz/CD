...
echo"<br>";
echo"<h3><center>Subdierector Académico</center> </h3>";
echo "</td>";
...
echo"<br>";
echo"<h3><center>Jefe de Departamento Desarrollo Académico</center> </h3>";
echo "</td>";
...
echo"<br>";
echo"<h3><center>Jefe de Departamento por Área</center> </h3>";
echo "</td>";
