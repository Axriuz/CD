...
<td rowspan="2">Nombre del documento:' .$nombredocto.' </td>
<td>Codigo: '.$cod.'</td>
</tr>
<tr>
...
$html.= '</tr>';
$html.= '</TABLE>';*/
$sql="SELECT Nombre,Objetivo,CursoInicio,CursoFin,Tec,Instructor,InsAux from curso where Year(CursoInicio)='$a' order by Nombre";
...
$html.=  mb_strtoupper($dato[1], "UTF-8");
	...
	//INSTRUCTORES
	$cadena="";
$sql1="SELECT ApellidoP,ApellidoN,Nombre,Area from maestro where Emp=$dato[5]"; 
