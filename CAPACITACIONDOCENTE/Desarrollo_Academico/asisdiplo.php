...
<body>
    ...
    <tr>
    <td>
    <P ALIGN=center STYLE=MARGIN-LEFT:0.07in>
    <IMG SRC='../Img/conscursos.png' >
    </td>
    <td>
    <CENTER>
    <h2>
    ...
    <form method='post' action='asisdiplo2.php' >
        <select name='diplomado'>
            <option value="DiplomadoCompetenciasDocentes">Diplomado para la Formación y Desarrollo de Competencias Docentes</option>
            <option value="DiplomadoTutores">Diplomado para la Formación de Tutores</option>
            <option value="DiplomadoVirtualesAprendizaje">Diplomado en Recursos Educativos en Ambientes Virtuales de Aprendizaje</option>
            <option value="DiplomadoEducacionInclusiva">Diplomado en Educación Inclusiva</option>
        </select>
        <br>
        <br>
        <input type='submit' name='Submit'   value='Consultar docentes' style='BORDER: #a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>
        <br><br>
    </form>
    </CENTER>
    </td>
