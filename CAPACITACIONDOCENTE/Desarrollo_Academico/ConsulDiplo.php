...
<nav class="navbar navbar-expand-lg navbar-light bg-#1b396a" style="background-color: #1b396a;">
	  ...
	  <br>
<?php
$dip1 = mysqli_query($con, "SELECT * FROM diplomados WHERE DiplomadoCompetenciasDocentes is not null");
echo "<div style=text-align:center;>";
echo "<table width='100%' border='7' cellpadding=30 CELLSPACING=30  bordercolor='#245c4f' ;>";

echo "<form action=pdfdiplomado.php method='post'   name= 'f1' id = 'f1'>";
echo "<tr>";
echo "<td>";
...
echo "<td>";
echo "<center>";
echo "<h2>CONSULTAR DIPLOMADO</h2>";
echo "Ingrese su clave de docente";
echo "<br><br>";
...
echo "<input type='submit'  name='Submit'   onClick='return compara()' value='Generar PDF de los diplomados' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</form>";
