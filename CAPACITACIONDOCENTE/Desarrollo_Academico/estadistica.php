...
echo "<br>";
echo "<br>";
echo "<input type ='submit' formaction='estadisticouno.php' value= 'Generar estadístico'  style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
