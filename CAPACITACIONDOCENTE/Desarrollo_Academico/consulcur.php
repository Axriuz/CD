...
<body>
	<!--Header -->
	<nav class="navbar navbar-expand-sm bg-light navbar-light" width:100%>
...
<nav class="navbar navbar-expand-lg navbar-light bg-#1b396a" style="background-color: #1b396a;" width: 100%>
...
echo "CONSULTAR DATOS DEL CURSO";

echo "</h2>";

echo "<form method='post' action='pdfcurso2.php' >";
$consulta_mysqli='select * from curso where activo= 1';
...
echo "<br>";
echo "<br>";
echo "<input type='submit' name='Submit' value='Generar PDF del curso' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</form>";
echo "<br>";
echo "<form method='post' action='cursomaestro.php' >";
echo "<input type='submit' name='Submit'   value='Generar PDF por maestro' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</form>";
echo "<br>";
echo "<form method='post' action='cursoperiodo.php' >";
echo "<input type='submit' name='Submit'   value='Generar PDF por periodo' style='BORDER: :#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</form>";
