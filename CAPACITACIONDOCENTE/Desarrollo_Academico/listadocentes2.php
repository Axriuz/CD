...
echo "<form action='docentespdf2.php' method='post'>";
...
echo "<input type ='submit' value= 'Generar Lista Excel' formaction='Excel2.php' style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
...
echo "<input type ='submit' value= 'Generar Todas las listas' formaction='todosdocentespdf2.php' style='BORDER::#a5273f 2px solid; BACKGROUND-COLOR: #a5273f; COLOR: #FCFCFD;'>"; 
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
