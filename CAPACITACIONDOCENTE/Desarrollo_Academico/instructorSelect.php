...
echo "<input type ='submit' formaction='encuestaInstructorCurso.php' value= 'Generar Reporte por Curso Activo'>"; 

echo "
<input type='submit' formaction='encuestaInstructor.php' value= 'Generar Reporte por año'>"; 
echo "</form>";
echo "</td>";
echo "</tr>";
echo "</table>";
